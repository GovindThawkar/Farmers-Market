...
const Home = () => {
  ...
  const loadFeaturedProducts = async () => {
    try {
      ...
      setFeaturedProducts(products.slice(0, 6)); // Show first 6 products as featured
    } catch (error) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Supporting local farmers and their families in your community
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Fresh products delivered quickly from farm to your doorstep
              </p>
            </div>
          </div>
        </div>
